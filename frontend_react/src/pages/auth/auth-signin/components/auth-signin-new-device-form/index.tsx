...
const NewDeviceForm = ({ onSubmit }: IPublicProps) => {
  const intl = useIntl();
      ...
      <CardContent>
        <HalfWidthHeadingContainer>
          <Title>
            ...
            <FormattedMessage defaultMessage="We see you're signing in from a new device." />
          </Title>
          <SubTitle>
            <FormattedMessage defaultMessage="As an additional security measure, you'll need to grant access to this device by entering special code we've just sent to your email address." />
          </SubTitle>
        </HalfWidthHeadingContainer>
        <FormContainer>
          <InputContainer>
